    ...
    private class Tokenizer {
        ...
        private ArrayList<Expression> tokenize(String input, boolean shouldBeMoreClosingParentheses) {
            ...
            for (; pos < input.length(); ++pos) {
                ...
                switch (curr_symbol) {
                    case '+':
                        tokens.add(new BinaryExpression(BinOpKind.ADD));
                        break;
                    case '-':
                        tokens.add(new BinaryExpression(BinOpKind.SUB));
                        break;
                    case '*':
                        tokens.add(new BinaryExpression(BinOpKind.MUL));
                        break;
                    case '/':
                        tokens.add(new BinaryExpression(BinOpKind.DIV));
                        break;
                    case ' ':
                        break;
                    default:
